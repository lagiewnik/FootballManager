...
import footballmanager.CustomComparator;
import footballmanager.FootballClub;
import footballmanager.LeagueManager;
import footballmanager.Match;

import java.text.ParseException;
import java.text.SimpleDateFormat;
import java.util.*;

public class EkstraklapaManager implements LeagueManager {
    ...
    public EkstraklapaManager(int numberOfClubs) {
    ...
    private void addTeam(String teamName, String teamLocation) {
        if (league.size() == numberOfClubs) {
            System.out.println("Can't add more clubs to league");
            return;
        }
